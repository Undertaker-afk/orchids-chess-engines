/**
 * Trinity-Preview-1.2 - Enhanced Search Engine
 * Improvements over 1.1:
 * - Aspiration windows for root search
 * - Enhanced move ordering with counter-move heuristic
 * - Improved time management
 * - Better LMR (Late Move Reductions) tuning
...
function search(depth, alpha, beta, is_pv) {
    ...
    for (let i = 0; i < count; i++) {
        ...
        if (legal === 1) score = -search(depth - 1, -beta, -alpha, is_pv);
            ...
            // Enhanced LMR with follow-up move bonus
