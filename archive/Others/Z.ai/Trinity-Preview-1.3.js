#!/usr/bin/env node
/**
 * Trinity-Preview-1.3 - JavaScript Chess Engine
 * 
 * Evolution path:
 *   1.2: Bug fixes (PST mapping, UCI, null move, mate scores) + SEE + aspiration windows
 *   1.3: + Continuation history + enhanced LMR + late move pruning + countermove
 *
 * Features:
...
function search(depth, alpha, beta, is_pv) {
    ...
    // No singular extensions in 1.3 (added in 1.4+)
    ...
    for (let i = 0; i < count; i++) {
        ...
        legal++;
        let score;
        let extension = 0; // No singular extensions in 1.3
